#ScaleWeaver Main Scale Program Call File
...
def show_banner():
    print('########################################################################')
    print('######### Multiscale Entropic Network Generator 2 (ScaleWeaver) #########')
    print('########################################################################')
...
def show_usage():
    ...
    print('-c, --citation    Citation information for ScaleWeaver')
    ...
    print(
        '                  Key parameters: edge_edit_rate, node_edit_rate, node_growth_rate, edge_growth_rate (all are lists of values e.g. [0.01, 0.02])')
    ...
    print(
        '-v, --visualizer  Visualization command to call after the replica has been prepared (Default: -v None). Try -v sfdp or -v sfdp3d')
